...
function buildSystemPrompt(profileJson: string): string {
  return `You are an expert CV and cover letter writer for Aw Thura, a professional AI/ML engineer based in Magdeburg, Germany.
...
async function handleGenerate(request: Request, env: Env): Promise<Response> {
  let body: { jd?: string; password?: string }
  try {
